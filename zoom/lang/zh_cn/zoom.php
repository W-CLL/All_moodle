...
$string['addtocalendar'] = '添加到日历<br/>Add to calendar';
...
$string['allmeetings'] = '所有课室<br/>All meetings';
...
$string['audio_both'] = '视频和电话<br/>VoIP and Telephony';
$string['audio_telephony'] = '只有语音<br/>Telephony only';
...
$string['downloadical'] = '下载日历<br/>Download iCal';
$string['duration'] = '持续时间<br/>Duration (minutes)';
$string['endtime'] = '结束时间<br/>End time';
...
$string['join_link'] = '课室链接<br/>Join link';
...
$string['meeting_finished'] = '结束<br/>Finished';
$string['meeting_not_started'] = 'Not started';
$string['meetingoptions'] = '会议选项<br/>Meeting option';
...
$string['meeting_started'] = '进行中<br/>In progress';
$string['meeting_time'] = '开始时间<br/>Start Time';
...
$string['on'] = 'On';
$string['option_audio'] = '声音选项<br/>Audio options';
$string['option_host_video'] = '主持人视频<br/>Host video';
$string['option_jbh'] = '允许主持人不在时加入<br/>Enable join before host';
$string['option_participants_video'] = '参与者视频<br/>Participants video';
$string['participants'] = 'Participants';
$string['password'] = '参与者密码<br/>Password';
$string['passwordprotected'] = '密码保护<br/>Password Protected';
...
$string['start'] = 'Start';
$string['starthostjoins'] = '主持人加入开启视频<br/>Start video when host joins';
$string['start_meeting'] = '进入课室<br/>Start Meeting';
$string['startpartjoins'] = '参与者加入时开启视频<br/>Start video when participant joins';
$string['start_time'] = '开始时间<br/>When';
$string['starttime'] = '开始时间<br/>Start time';
$string['status'] = '状态<br/>Status';
$string['title'] = 'Title';
$string['topic'] = '课室名称<br/>Topic';
$string['unavailable'] = '课室不在服务时间内，请等待或重新设置开始时间。<br/>Unable to join at this time';
...
//下载记录
$string['Now'] = '下载会议记录。</br>Download Meeting Records ';
$string['downloadrecords'] = '下载会议记录。</br>Download Meeting Records</br>(注：尽量课室结束前下载会议记录)';
$string['Not'] = '没有这个会议,或者会议还没开始，请在课程开始后再进行下载。No meeting, or the meeting has not started yet, please download it after the course starts';
$string['username'] = '用户名';
$string['join_time'] = '加入时间';
$string['leave_time'] = '离开时间';
$string['leave_reason'] = '离开原因';
$string['n_reason'] = '无';
$string['n_leave'] = '暂时没离开过';