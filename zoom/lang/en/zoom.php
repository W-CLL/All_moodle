...
//下载记录
$string['downloadrecords'] = 'Download Meeting Record  At This Time</br>(Please try to download before the end of the meeting)';
$string['Now'] = 'Download Meeting Records';
$string['Not'] = 'No meeting, or the meeting has not started yet, please download it after the course starts';
$string['username'] = 'Username';
$string['join_time'] = 'Join Time';
$string['leave_time'] = 'Leave Time';
$string['leave_reason'] = 'Leave Reason';
$string['n_reason'] = 'No';
$string['n_leave'] = 'Never left';
